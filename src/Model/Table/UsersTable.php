...
class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ...
            ->notEmptyString('first_name','Please fill the first name')
            ->add('first_name', [
                'first_name' => [
                    'rule' => ['custom', '/^[A-Za-z_]*$/'],
                    'message' => 'Please enter text values',
                ]
            ]);
        ...
        $validator
            ...
            ->notEmptyString('last_name','Please fill the last name')
            ->add('last_name', [
                'last_name' => [
                    'rule' => ['custom', '/^[A-Za-z_]*$/'],
                    'message' => 'Please enter text values',
        ...
        $validator
            ...
            ->notEmptyString('password','Please fill the password');
